...
wire [2:0] w_sw;
assign w_sw[0] = w_control_in[5] ? ( sw[0] ? 0 : 1 ) : w_sw[0];
assign w_sw[1] = w_control_in[6] ? ( sw[1] ? 0 : 1 ) : w_sw[1];
assign w_sw[2] = w_control_in[7] ? ( sw[2] ? 0 : 1 ) : w_sw[2];
