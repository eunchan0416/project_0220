...
module top_stopwatch_watch (
    ...
    output o_watch_up_r,
    output o_watch_up_l,
    output o_watch_change,

    output o_w_100hz_tick,
    output o_w_sec_tick,
    output o_w_min_tick,
    output o_w_hour_tick
);
    wire [13:0] w_counter;
    ...
    control_unit U_CONTROL_UNIT (
        ...
        .o_clear(o_clear),
        .o_mode(o_mode),
        .o_watch_up_r(o_watch_up_r),
        .o_watch_up_l(o_watch_up_l),
        .o_watch_change(o_watch_change)
    );
    ...
    watch_datapath U_WATCH_DATAPATH (
        ...
        .reset(reset),
        .sel_display(sw[2]),
        .up_l(o_watch_up_l),  // left time
        .up_r(o_watch_up_r),  // right time
        .change(o_watch_change),  // sw[0] = 1 change
        .msec(watch_time[6:0]),
        .sec(watch_time[12:7]),
        .min(watch_time[18:13]),
        .hour(watch_time[23:19]),
        .o_w_100hz_tick(o_w_100hz_tick),
        .o_w_sec_tick(o_w_sec_tick),
        .o_w_min_tick(o_w_min_tick),
        .o_w_hour_tick(o_w_hour_tick)
    );
