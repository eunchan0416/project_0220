...
module control_unit (
    input      clk,
    input      reset,
    input      [1:0]i_sel_mode,     //sw : 0:stopwatch, 1: watch, 2: sr04, 3: dht
    input      i_mode,         //sw[0]
    input      i_run_stop,
    input      i_clear,
    input      i_btn_up_r,
    ...
    always @(*) begin
        ...
        if (i_sel_mode == 0) begin
            ...
            endcase
        end else if(i_sel_mode == 1) begin
            o_watch_change = i_mode;
            o_watch_up_l   = i_btn_up_l;
            o_watch_up_r   = i_btn_up_r;
        end else if(i_sel_mode == 2) begin
            o_sr04_start = i_run_stop;
        end else begin
                o_dht_start= i_run_stop;
        end
    end
